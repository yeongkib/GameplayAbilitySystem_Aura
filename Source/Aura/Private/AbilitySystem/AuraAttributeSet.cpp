...
TagsToAttributeMap.Add(TAG_Attributes_##AttributeType##_##AttributeName, Get##AttributeName##Attribute());
	...
	MAP_TAG_TO_ATTRIBUTE(Resistance, FireResistance);
	MAP_TAG_TO_ATTRIBUTE(Resistance, LightningResistance);
	MAP_TAG_TO_ATTRIBUTE(Resistance, ArcaneResistance);
	MAP_TAG_TO_ATTRIBUTE(Resistance, PhysicalResistance);
